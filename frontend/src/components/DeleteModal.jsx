...
export default function DeleteModal({ isOpen, onClose, onConfirm, employeeName }) {
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  Are you sure you want to delete <span className="font-bold text-gray-800">{employeeName}</span>? 
                  All of their attendance data will be permanently removed. This action cannot be undone.
                </p>
              </div>
            </div>
          </div>
